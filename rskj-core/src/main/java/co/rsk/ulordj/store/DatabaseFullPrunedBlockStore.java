...
public abstract class DatabaseFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    /**
     * Create a new store for the given {@link co.rsk.ulordj.core.NetworkParameters}.
     ...
     *
     * <p>The balance {@link co.rsk.ulordj.store.DatabaseFullPrunedBlockStore#getBalanceSelectSQL()} returns
