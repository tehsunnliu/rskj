...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link co.rsk.ulordj.core.BlockChain#getChainHead()}
     * or perhaps {@link co.rsk.ulordj.core.BlockChain#getBestChainHeight()} which will run in constant time and
    ...
    /**
     * Get the {@link co.rsk.ulordj.core.NetworkParameters} of this store.
