...
import co.rsk.ulordj.core.Transaction.SigHash;
...
/**
 * A TransactionSignature wraps an {@link co.rsk.ulordj.core.ECKey.ECDSASignature} and adds methods for handling
