...
import static co.rsk.ulordj.core.Utils.HEX;
...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns this keys {@link co.rsk.ulordj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override @Nullable
     ...
     * in which case the time is stored alongside the key as per normal, see {@link co.rsk.ulordj.core.ECKey#getCreationTimeSeconds()}.
     */
    @Override
