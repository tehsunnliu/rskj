...
import co.rsk.ulordj.net.AbstractTimeoutHandler;
import co.rsk.ulordj.net.MessageWriteTarget;
 ...
 * {@link co.rsk.ulordj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamConnection {
     ...
     * called automatically by {@link co.rsk.ulordj.net.NioClient} or
     * {@link co.rsk.ulordj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
