...
import co.rsk.bitcoin.NativeSecp256k1;
import co.rsk.bitcoin.NativeSecp256k1Util;
import co.rsk.bitcoin.Secp256k1Context;
import co.rsk.ulordj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws co.rsk.ulordj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link co.rsk.ulordj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link co.rsk.ulordj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws co.rsk.ulordj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link co.rsk.ulordj.core.DumpedPrivateKey#toString()} method to get the string.
     *
