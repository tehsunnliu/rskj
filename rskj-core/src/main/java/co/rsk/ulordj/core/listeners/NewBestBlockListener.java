...
package co.rsk.ulordj.core.listeners;
...
public interface NewBestBlockListener {
     ...
     * {@link TransactionReceivedInBlockListener#receiveFromBlock(co.rsk.ulordj.core.Transaction, StoredBlock, co.rsk.ulordj.core.AbstractBlockChain.NewBlockType, int)}
     * or {@link TransactionReceivedInBlockListener#notifyTransactionIsInBlock(co.rsk.ulordj.core.Sha256Hash, StoredBlock, co.rsk.ulordj.core.AbstractBlockChain.NewBlockType, int)}.
