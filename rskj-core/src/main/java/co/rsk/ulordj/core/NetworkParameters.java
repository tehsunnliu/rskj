 ...
 */
//TODO: Update Ulord network parameters
package co.rsk.ulordj.core;

import com.google.common.base.Objects;
import co.rsk.ulordj.core.Block;
import co.rsk.ulordj.core.StoredBlock;
import co.rsk.ulordj.core.VerificationException;
import co.rsk.ulordj.net.discovery.*;
import co.rsk.ulordj.params.*;
import co.rsk.ulordj.script.*;
import co.rsk.ulordj.store.BlockStore;
import co.rsk.ulordj.store.BlockStoreException;

import co.rsk.ulordj.utils.MonetaryFormat;
...
import static co.rsk.ulordj.core.Coin.*;
import co.rsk.ulordj.utils.VersionTally;
...
public abstract class NetworkParameters {
    ...
    public static final int TARGET_TIMESPAN = 14 * 24 * 60 * 60;  // 2 weeks per difficulty cycle, on average.  // TODO: Update Ulord difficulty cycle;
    public static final int TARGET_SPACING = (int)(2.5 * 60);  // 10 minutes per block.     // TODO: Update Ulord block spawn time
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link co.rsk.ulordj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link co.rsk.ulordj.core.LegacyAddress}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link co.rsk.ulordj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link co.rsk.ulordj.core.AlertMessage}s. You can use {@link co.rsk.ulordj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
