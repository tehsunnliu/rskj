...
public class Context {
    ...
    /**
     * Require that new threads use {@link #propagate(Context)} or {@link co.rsk.ulordj.utils.ContextPropagatingThreadFactory},
     ...
     * a {@link co.rsk.ulordj.utils.ContextPropagatingThreadFactory}.
     */
    ...
    /**
     * Returns the {@link co.rsk.ulordj.core.NetworkParameters} specified when this context was (auto) created. The
