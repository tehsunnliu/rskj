...
import co.rsk.ulordj.wallet.Wallet;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link co.rsk.ulordj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link co.rsk.ulordj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link co.rsk.ulordj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link co.rsk.ulordj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link co.rsk.ulordj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link co.rsk.ulordj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link co.rsk.ulordj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link co.rsk.ulordj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link co.rsk.ulordj.core.Peer#ping()}.
     */
