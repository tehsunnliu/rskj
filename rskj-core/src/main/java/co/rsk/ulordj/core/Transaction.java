...
import co.rsk.ulordj.core.TransactionConfidence.ConfidenceType;
import co.rsk.ulordj.crypto.TransactionSignature;
import co.rsk.ulordj.script.Script;
import co.rsk.ulordj.script.ScriptBuilder;
import co.rsk.ulordj.script.ScriptError;
import co.rsk.ulordj.script.ScriptException;
import co.rsk.ulordj.script.ScriptOpCodes;
import co.rsk.ulordj.script.ScriptPattern;
import co.rsk.ulordj.signers.TransactionSigner;
import co.rsk.ulordj.utils.ExchangeRate;
import co.rsk.ulordj.wallet.Wallet;
import co.rsk.ulordj.wallet.WalletTransaction.Pool;
...
import static co.rsk.ulordj.core.Utils.*;
...
public class Transaction extends ChildMessage {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, co.rsk.ulordj.script.Script, ECKey, co.rsk.ulordj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], co.rsk.ulordj.core.Transaction.SigHash, boolean)}
    ...
    /**
     * Returns the confidence object for this transaction from the {@link co.rsk.ulordj.core.TxConfidenceTable}
