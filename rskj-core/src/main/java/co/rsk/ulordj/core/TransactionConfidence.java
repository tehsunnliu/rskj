...
import co.rsk.ulordj.core.listeners.BlockChainListener;
 ...
 *
 * <p>TransactionConfidence is updated via the {@link co.rsk.ulordj.core.TransactionConfidence#incrementDepthInBlocks()}
 * method to ensure the block depth is up to date.</p>
 * To make a copy that won't be changed, use {@link co.rsk.ulordj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link co.rsk.ulordj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        enum ChangeReason {
            /**
             * Occurs when the type returned by {@link co.rsk.ulordj.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link co.rsk.ulordj.wallet.CoinSelector} implementations to risk analyze
