 ...
 * the lightweight SPV mode, a {@link co.rsk.ulordj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link co.rsk.ulordj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
