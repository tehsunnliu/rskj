...
import co.rsk.ulordj.net.StreamConnection;
import co.rsk.ulordj.store.BlockStore;
import co.rsk.ulordj.store.BlockStoreException;
import co.rsk.ulordj.utils.ListenerRegistration;
 ...
 * {@link co.rsk.ulordj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link co.rsk.ulordj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link co.rsk.ulordj.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link co.rsk.ulordj.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link co.rsk.ulordj.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link co.rsk.ulordj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link co.rsk.ulordj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link co.rsk.ulordj.core.Peer#ping()} has never
