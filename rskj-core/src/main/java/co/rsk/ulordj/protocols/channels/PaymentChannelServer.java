...
public class PaymentChannelServer {
     ...
     * {@link co.rsk.ulordj.protocols.channels.PaymentChannelServer.ServerConnection#destroyConnection(co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link co.rsk.ulordj.protocols.channels.PaymentChannelServer.ServerConnection#destroyConnection(co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason)}. Note that this does not broadcast
