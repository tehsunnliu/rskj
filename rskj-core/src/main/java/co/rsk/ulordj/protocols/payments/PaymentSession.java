...
package co.rsk.ulordj.protocols.payments;

import co.rsk.ulordj.core.*;
import co.rsk.ulordj.crypto.TrustStoreLoader;
import co.rsk.ulordj.params.MainNetParams;
import co.rsk.ulordj.protocols.payments.PaymentProtocol.PkiVerificationData;
import co.rsk.ulordj.uri.BitcoinURI;
...
import co.rsk.bitcoin.protocols.payments.Protos;
 ...
 * <li>A url where the {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest} object</li>
 * </ul>
 *
 ...
 *
 * <p>Call sendPayment with a list of transactions that will be broadcast. A {@link co.rsk.bitcoin.protocols.payments.Protos.Payment} message will be sent
 ...
 * {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentACK} is received from the merchant. Typically a wallet will show the message to the user
...
public class PaymentSession {
     ...
     * uri is a BIP-72-style BitcoinURI object that specifies where the {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest} object may
     ...
     * url is an address where the {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest} object may be fetched.
     * If verifyPki is specified and the payment request object specifies a PKI method, then the system trust store will
     * be used to verify the signature provided by the payment request. An exception is thrown by the future if the
     * signature cannot be verified.
     */
    ...
    /**
     * Creates a PaymentSession from the provided {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest}.
