...
package co.rsk.ulordj.protocols.channels;
...
import co.rsk.bitcoin.paymentchannel.Protos;
import co.rsk.ulordj.wallet.SendRequest;
...
public interface IPaymentChannelClient {
     ...
     * {@link co.rsk.ulordj.protocols.channels.IPaymentChannelClient.ClientConnection#destroyConnection(co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason)} or
     ...
     * {@link co.rsk.ulordj.protocols.channels.IPaymentChannelClient.ClientConnection#destroyConnection(co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason)}
    ...
    interface ClientConnection {
         ...
         * {@link co.rsk.ulordj.protocols.channels.PaymentChannelClient#connectionClosed()} should be called immediately. In the case of messages which
         ...
         *
         * <p>Called while holding a lock on the {@link co.rsk.ulordj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         */
         ...
         * {@link co.rsk.ulordj.protocols.channels.PaymentChannelClient#connectionClosed()} event should be generated immediately after this call.</p>
         *
         * <p>Called while holding a lock on the {@link co.rsk.ulordj.protocols.channels.PaymentChannelClient} object - be careful about reentrancy</p>
         *
         ...
         *               {@link co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason#CLIENT_REQUESTED_CLOSE} as "unrecoverable error" and all others as
         ...
         * will be closed with a  {@link co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason#TIME_WINDOW_UNACCEPTABLE}.</p>
         ...
         * {@link co.rsk.ulordj.protocols.channels.PaymentChannelClient#incrementPayment(Coin)}
         * may be called at will.</p>
         *
         * <p>Called while holding a lock on the {@link co.rsk.ulordj.protocols.channels.PaymentChannelClient}
    ...
    interface ClientChannelProperties {
         ...
         *  See {@link co.rsk.ulordj.protocols.channels.IPaymentChannelClient.ClientConnection#acceptExpireTime(long)}
         *
         */
        long timeWindow();
