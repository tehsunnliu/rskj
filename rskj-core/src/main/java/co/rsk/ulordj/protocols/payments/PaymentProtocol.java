...
import co.rsk.ulordj.crypto.X509Utils;
...
public class PaymentProtocol {
     ...
     * {@link #signPaymentRequest}. Use {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest.Builder#build} to get the actual payment
     * request.
     *
     ...
     * {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest.Builder#build} to get the actual payment request.
     * 
     * @param params network parameters
     ...
     * @return verification data, or null if no PKI method was specified in the {@link co.rsk.bitcoin.protocols.payments.Protos.PaymentRequest}.
