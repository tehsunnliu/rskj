...
public abstract class ServerConnectionEventHandler {
     ...
     * {@link StoredPaymentChannelServerStates#getChannel(co.rsk.ulordj.core.Sha256Hash)} with the id provided in
     * {@link ServerConnectionEventHandler#channelOpen(co.rsk.ulordj.core.Sha256Hash)}</p>
     */
