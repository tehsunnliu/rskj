...
import co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     * {@link co.rsk.ulordj.protocols.channels.IPaymentChannelClient.ClientConnection#destroyConnection(co.rsk.ulordj.protocols.channels.PaymentChannelCloseException.CloseReason)} to settle the connection, it does not
