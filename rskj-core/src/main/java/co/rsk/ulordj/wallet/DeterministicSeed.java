...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link co.rsk.ulordj.crypto.MnemonicCode} for more
     ...
     *
     * @throws co.rsk.ulordj.crypto.MnemonicException if check fails
     */
