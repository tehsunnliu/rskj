...
import co.rsk.ulordj.crypto.KeyCrypter;
import co.rsk.ulordj.crypto.KeyCrypterScrypt;
import co.rsk.ulordj.script.Script;
import co.rsk.ulordj.script.ScriptException;
import co.rsk.ulordj.signers.LocalTransactionSigner;
import co.rsk.ulordj.signers.TransactionSigner;
import co.rsk.ulordj.utils.ExchangeRate;
import co.rsk.ulordj.utils.Fiat;
import co.rsk.ulordj.wallet.Protos.Wallet.EncryptionType;
...
public class WalletProtobufSerializer {
    ...
    private WalletTransaction connectTransactionOutputs(final NetworkParameters params,
                                                        final co.rsk.ulordj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
