...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link co.rsk.ulordj.wallet.Wallet}. Key chains
...
public interface KeyChain {
     ...
     *
     * <p>See the docs for {@link co.rsk.ulordj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
