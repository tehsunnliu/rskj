...
import co.rsk.ulordj.script.Script;
import co.rsk.ulordj.utils.Threading;
 ...
 * {@link co.rsk.ulordj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link co.rsk.ulordj.crypto.MnemonicCode},
 ...
 * {@link co.rsk.ulordj.crypto.DeterministicKey#serializePubB58(co.rsk.ulordj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link co.rsk.ulordj.crypto.DeterministicKey#deserializeB58(co.rsk.ulordj.crypto.DeterministicKey, String, co.rsk.ulordj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(co.rsk.ulordj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link co.rsk.ulordj.crypto.DeterministicHierarchy} and
 * {@link co.rsk.ulordj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     *  Using {@link co.rsk.ulordj.crypto.KeyCrypter KeyCrypter} to decrypt.
     */
    protected DeterministicKeyChain(DeterministicSeed seed, @Nullable KeyCrypter crypter,
     ...
     * The returned key can be serialized and then passed into {@link #watch(co.rsk.ulordj.crypto.DeterministicKey)}
     ...
     * @see co.rsk.ulordj.wallet.MarriedKeyChain
     */
