...
import co.rsk.ulordj.crypto.KeyCrypterException;
...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(co.rsk.ulordj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link co.rsk.ulordj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link co.rsk.ulordj.wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
