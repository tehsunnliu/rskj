...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws co.rsk.ulordj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws co.rsk.ulordj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(co.rsk.ulordj.crypto.KeyCrypter,
