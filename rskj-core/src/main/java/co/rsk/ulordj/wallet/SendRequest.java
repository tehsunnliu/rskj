...
import co.rsk.bitcoin.protocols.payments.Protos.PaymentDetails;
...
import co.rsk.ulordj.wallet.KeyChain.KeyPurpose;
import co.rsk.ulordj.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link co.rsk.ulordj.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link co.rsk.ulordj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
