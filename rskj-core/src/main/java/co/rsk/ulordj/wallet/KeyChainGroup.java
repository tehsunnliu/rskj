...
import co.rsk.ulordj.script.Script.ScriptType;
...
/**
 * <p>A KeyChainGroup is used by the {@link co.rsk.ulordj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws co.rsk.ulordj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link co.rsk.ulordj.crypto.KeyCrypterScrypt}.
     *
     * @throws co.rsk.ulordj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
