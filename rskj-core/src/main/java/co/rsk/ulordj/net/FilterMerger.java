...
/**
 * <p>A reusable object that will calculate, given a list of {@link co.rsk.ulordj.core.PeerFilterProvider}s, a merged
 * {@link co.rsk.ulordj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link co.rsk.ulordj.core.PeerGroup} class internally.</p>
 *
