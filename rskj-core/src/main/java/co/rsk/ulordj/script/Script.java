...
import static co.rsk.ulordj.script.ScriptOpCodes.*;
...
public class Script {
     ...
     * {@link co.rsk.ulordj.core.TransactionInput#verify(co.rsk.ulordj.core.TransactionOutput)} or
     * {@link co.rsk.ulordj.script.Script#correctlySpends(co.rsk.ulordj.core.Transaction, long, Script)}. This method
     * is useful if you need more precise control or access to the final state of the stack. This interface is very
     * likely to change in future.
     *
     * @deprecated Use {@link #executeScript(co.rsk.ulordj.core.Transaction, long, co.rsk.ulordj.script.Script, java.util.LinkedList, java.util.Set)}
     * instead.
     */
    @Deprecated
     ...
     * @deprecated Use {@link #correctlySpends(co.rsk.ulordj.core.Transaction, long, co.rsk.ulordj.script.Script, java.util.Set)}
    ...
    /**
     * Get the {@link co.rsk.ulordj.script.Script.ScriptType}.
