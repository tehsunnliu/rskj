 ...
 *
 * @see co.rsk.ulordj.core.NetworkParameters#getMajorityWindow()
 * @see co.rsk.ulordj.core.NetworkParameters#getMajorityEnforceBlockUpgrade()
 * @see co.rsk.ulordj.core.NetworkParameters#getMajorityRejectBlockOutdated()
 */
