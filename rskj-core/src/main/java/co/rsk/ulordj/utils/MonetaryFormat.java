...
import co.rsk.ulordj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link co.rsk.ulordj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link co.rsk.ulordj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
