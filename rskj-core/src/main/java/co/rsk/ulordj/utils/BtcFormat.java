...
import co.rsk.ulordj.utils.BtcAutoFormat.Style;
import static co.rsk.ulordj.utils.BtcAutoFormat.Style.*;
 ...
 * method.  This argument can be either a {@link co.rsk.ulordj.core.Coin}-type object or a
...
public abstract class BtcFormat extends Format {
    ...
    /**
      ...
      * {@link co.rsk.ulordj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
