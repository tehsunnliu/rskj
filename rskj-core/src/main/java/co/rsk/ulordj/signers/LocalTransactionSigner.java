...
import co.rsk.ulordj.script.Script.VerifyFlag;
import co.rsk.ulordj.wallet.KeyBag;
import co.rsk.ulordj.wallet.RedeemData;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link co.rsk.ulordj.wallet.KeyBag}.</p>
 ...
 * {@link co.rsk.ulordj.signers.TransactionSigner.ProposedTransaction} object that will be also passed then to the next signer in chain. This allows other
 ...
 * <p>This signer always uses {@link co.rsk.ulordj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
